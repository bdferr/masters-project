#This script divides the first half of the non-gold standard corpus into folds
#of progressively larger sizes to be used as training sets.
#It also creates a test set consisting of untagged versions of the files in the gold standard.
#This is the script which I ultimately used for the final processing before the tagging,
#in contrast with the earlier and more convoluted sampler1.py which I abandoned.
import random
import re
import os
import nltk
