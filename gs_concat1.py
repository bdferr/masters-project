#This file concatenates all of the tagged and processed files from the first half of the gold standard corpus
#into a single file, then does the same in a second file for the untagged and processed files.
import os
import re
#here I access all of the file names in the already processed directory for the tagged first half:
...
with open("%s" % endpath,'w') as f:
    ...
    f.close()
#here I access all of the file names in the already processed directory for the untagged first half:
