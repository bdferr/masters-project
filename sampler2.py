#This is an earlier and more convoluted version of the script I ultimately ended up using
#for the second half of the corpus, sampler2b.py.
...
import os
import nltk
secondhalfdir = 'C:/users/brendan/documents/library and information science/masters_project/germanc-corpus/second_half_col/processed'
...
##here I try to create the held-out test set:
testset = ''
n = 1
filenamess = ''
filenamesl = []
...
trainsource = testsource = secondhalf
...
for fold in greaterfolds:
    ...
    if f:
        ...
        while i <= Ltestsizes[d] and len(foldfiles) > 0:
            ...
            pathu = secondhalfdir + "/" + choice + "_untagged.txt"
        ...
        while j <= Ltrainsizes[d] and len(foldfiles) > 0:
            ...
            patht = secondhalfdir + "/" + choice + "_tagged.txt"
